...
#define PRIMARY(what)                                                          \
  (fmt::styled(what, fg(fmt::color::magenta) | fmt::emphasis::bold))
...
hclang::IntegerConstant::IntegerConstant(std::uint64_t value,
                                         hclang::typeInfo t,
  ...
  case hct::Union:
    throw std::invalid_argument(
        fmt::format("{} is not an integer type", typeToString(type)));
    break;
  case hct::I0i:
  case hct::U0i:
    throw std::invalid_argument(
        fmt::format("{} cannot have constants", typeToString(type)));
    break;
...
hclang::IntegerConstant
hclang::IntegerConstant::makeI8(std::string_view src, int base,
                                std::optional<Lexeme> l) {
  std::int8_t value = 0;
  ...
  case std::errc::result_out_of_range:
    throw std::range_error(
        fmt::format("{} is out of range of 8 bit integer", src));
    break;
  default:
    break;
  }

  return IntegerConstant(static_cast<std::uint64_t>(value),
                         {""sv, nullptr, HCType::I8i}, l);
}

hclang::IntegerConstant
hclang::IntegerConstant::makeU8(std::string_view src, int base,
                                std::optional<Lexeme> l) {
  std::uint8_t value = 0;
  auto [ptr, ec] = std::from_chars(src.begin(), src.end(), value, base);
  ...
  case std::errc::result_out_of_range:
    throw std::range_error(
        fmt::format("{} is out of range of 8 bit unsigned integer", src));
    break;
  default:
    break;
  }
  return IntegerConstant(static_cast<std::uint64_t>(value),
                         {""sv, nullptr, HCType::U8i}, l);
}

hclang::IntegerConstant
hclang::IntegerConstant::makeI16(std::string_view src, int base,
                                 std::optional<Lexeme> l) {
  std::int16_t value = 0;
  auto [ptr, ec] = std::from_chars(src.begin(), src.end(), value, base);
  ...
  case std::errc::result_out_of_range:
    throw std::range_error(
        fmt::format("{} is out of range of 16 bit integer", src));
    break;
  default:
    break;
  }
  return IntegerConstant(static_cast<std::uint64_t>(value),
                         {""sv, nullptr, HCType::I16i}, l);
}

hclang::IntegerConstant
hclang::IntegerConstant::makeU16(std::string_view src, int base,
                                 std::optional<Lexeme> l) {
  ...
  case std::errc::result_out_of_range:
    throw std::range_error(
        fmt::format("{} is out of range of 16 bit unsigned integer", src));
    break;
  default:
    break;
  }
  return IntegerConstant(static_cast<std::uint64_t>(value),
                         {""sv, nullptr, HCType::U16i}, l);
}

hclang::IntegerConstant
hclang::IntegerConstant::makeI32(std::string_view src, int base,
                                 std::optional<Lexeme> l) {
  std::int32_t value = 0;
  auto [ptr, ec] = std::from_chars(src.begin(), src.end(), value, base);
  ...
  case std::errc::result_out_of_range:
    throw std::range_error(
        fmt::format("{} is out of range of 32 bit integer", src));
    break;
  default:
    break;
  }
  return IntegerConstant(static_cast<std::uint64_t>(value),
                         {""sv, nullptr, HCType::I32i}, l);
}

hclang::IntegerConstant
hclang::IntegerConstant::makeU32(std::string_view src, int base,
                                 std::optional<Lexeme> l) {
  ...
  case std::errc::result_out_of_range:
    throw std::range_error(
        fmt::format("{} is out of range of 32 bit unsigned integer", src));
    break;
  default:
    break;
  }
  ...
  return IntegerConstant(static_cast<std::uint64_t>(value),
                         {""sv, nullptr, HCType::U32i}, l);
}

hclang::IntegerConstant
hclang::IntegerConstant::makeI64(std::string_view src, int base,
                                 std::optional<Lexeme> l) {
  std::int64_t value = 0;
  auto [ptr, ec] = std::from_chars(src.begin(), src.end(), value, base);
  ...
  case std::errc::result_out_of_range:
    throw std::range_error(
        fmt::format("{} is out of range of 64 bit integer", src));
    break;
  default:
    break;
  }
  return IntegerConstant(static_cast<std::uint64_t>(value),
                         {""sv, nullptr, HCType::I64i}, l);
}

hclang::IntegerConstant
hclang::IntegerConstant::makeU64(std::string_view src, int base,
                                 std::optional<Lexeme> l) {
  ...
  case std::errc::result_out_of_range:
    throw std::range_error(
        fmt::format("{} is out of range of 64 bit unsigned integer", src));
    break;
  default:
    break;
  }
  return IntegerConstant(static_cast<std::uint64_t>(value),
                         {""sv, nullptr, HCType::U64i}, l);
}
...
void hclang::IntegerConstant::pprint() const {
  printDefault();
  if (mIsSigned) {
    fmt::print(" {} {}", SECONDARY(mType),
               PRIMARY(static_cast<std::int64_t>(mValue)));
  } else {
...
std::string_view hclang::Return::getClassName() const { return "Return"; }
...
hclang::DeclarationReference::DeclarationReference(
    const hclang::Identifier &id, Type type,
    const hclang::SymbolTable<decl> &table, std::optional<Lexeme> l)
...
void hclang::DeclarationReference::pprint() const {
  ...
  fmt::print(" {} {} {}{:x}", PRIMARY(stringifyType()),
             PRIMARY(mDeclRef->getIdRef()), SECONDARY("0x"),
             SECONDARY(address));
}
...
void hclang::LToRValue::pprint() const { printDefault(); }

std::string_view hclang::LToRValue::getClassName() const { return "LToRValue"; }
...
hclang::Cast::Cast(hclang::exp expr, hclang::typeInfo into,
                   std::optional<Lexeme> l)
...
std::string_view hclang::Cast::getClassName() const { return "Cast"; }

std::list<hclang::GR> hclang::Cast::getChildren() const { return {mExpr}; }
...
hclang::VariableInitialization::VariableInitialization(
    const hclang::Identifier &id, hclang::typeInfo type, hclang::exp expr)
...
void hclang::VariableInitialization::pprint() const {
  ...
  fmt::print(
      " {} {}",
      fmt::styled(getType(), fg(fmt::color::light_green) | fmt::emphasis::bold),
...
void hclang::Program::add(hclang::cmpdStmnt pd) {
  ...
  if (mStatements.empty() ||
      std::holds_alternative<funcDefn>(mStatements.back())) {
...
void hclang::Program::pprint() const {
  ...
  while (!stack.empty()) {
    ...
    fmt::print("{:{}}{}-", "", indentLevel * 2 - 1,
               (indentLevel != lastLevel) ? '`' : '|');
    curObj->pprint();
    fmt::print("\n");
...
std::string_view hclang::Program::getClassName() const { return "Program"; }
...
void hclang::CompoundStatement::pprint() const { printDefault(); }
...
void hclang::BinaryOperator::pprint() const {
  printDefault();
  fmt::print(" {}", fmt::styled(hclang::operatorToString(mOp),
...
void hclang::DeclarationStatement::pprint() const { printDefault(); }
...
void hclang::FunctionDefinition::pprint() const { printDefault(); }
...
void hclang::FunctionDeclaration::pprint() const { printDefault(); }
...
std::string_view hclang::If::getClassName() const { return "IfStatement"; }
...
void hclang::ElseIf::pprint() const { printDefault(); }
...
void hclang::Goto::pprint() const { printDefault(); }

std::string_view hclang::Goto::getClassName() const { return "Goto"; }
...
void hclang::Label::pprint() const { printDefault(); }

std::string_view hclang::Label::getClassName() const { return "Label"; }

std::list<hclang::GR> hclang::Label::getChildren() const { return {}; }

// For

void hclang::For::pprint() const { printDefault(); }

std::string_view hclang::For::getClassName() const { return "ForStatement"; }
...
void hclang::FunctionCall::pprint() const { printDefault(); }
...
std::string_view hclang::typeToString(hclang::HCType type) {
  ...
  throw std::invalid_argument(
      fmt::format("{} is not a valid HCType", static_cast<int>(type)));
}
